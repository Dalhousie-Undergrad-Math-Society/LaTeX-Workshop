...
\newcommand{\st}{\mid} % Such That Bar for Sets
...
\newcommand{\ax}[1]{\tag{By #1}} % Easier for writing axiomatic proofs
...
\renewcommand{\bold}[1]{{\textbf{#1}}} % for bold text
\renewcommand{\cal}[1]{\mathcal{#1}} % Easy mathcal
\newcommand{\bb}[1]{\mathbb{#1}} % Easy mathbb
\newcommand{\otk}[1]{#1_1,\dots,#1_k} % Easy Lists of Vectors
\newcommand{\oneto}[2]{#1_1, \dots, #1_{#2}} % Easy lists that don't use k
...
\newcommand{\U}{\mathcal{U}} % Caligraphic U 
\newcommand{\V}{\mathcal{V}} % Caligraphic V 
\newcommand{\W}{\mathcal{W}} % Caligraphic W
\newcommand{\nothing}{\varnothing}
% Bold Maths Symbols
...
\newcommand{\del}{ \partial } % Partial Differential
\newcommand{\proj}[2][]{\textit{proj}_{\vb{#2}}\vb{#1}} % projection of a onto b \proj{a}{b}
\newcommand{\comp}[2][]{\textit{comp}_{\vb{#2}}\vb{#1}}
